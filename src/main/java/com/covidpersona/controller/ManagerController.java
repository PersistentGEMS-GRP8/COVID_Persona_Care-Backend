...
public class ManagerController {
	...
	public ResponseEntity<Manager> addManager(@RequestBody Manager manager) {
		log.info("Request to create manager: {}", manager);
	...
	public ResponseEntity<Manager> updateManager(@RequestBody Manager manager) {
		log.info("Request to update manager: {}", manager);
	...
	public ResponseEntity<?> deleteManager(@PathVariable long id) {
		log.info("Request to delete manager: {}", id);
	...
	public long registerManager(@RequestBody RegisterRequestDto dto) {
		log.info("Request to register manager: {}", dto.getPerson());
